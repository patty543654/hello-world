...
(function () {
    ...
    var new_column1 = "<p>Goodbye World</p>";
    var new_column2 = "<p>Goodbye World</p>";
    var old_column1 = "";
    var old_column2 = "";
    ...
    document.getElementById("hello-world-column1").
    addEventListener("click", toggleleft);
    document.getElementById("hello-world-column2").
